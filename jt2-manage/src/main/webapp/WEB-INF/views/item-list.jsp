...
<table class="easyui-datagrid" id="itemList" title="商品列表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'cid',width:100,align:'center',formatter:KindEditorUtil.findItemCatName">商品分類</th>
            ...
            <th data-options="field:'barcode',width:100">條碼</th>
            <th data-options="field:'status',width:60,align:'center',formatter:KindEditorUtil.formatItemStatus">狀態</th>
            <th data-options="field:'created',width:130,align:'center',formatter:KindEditorUtil.formatDateTime">創建日期</th>
...
<script>
    ...
    var toolbar = [{
        ...
        handler:function(){
        	...
        	$("#itemEditWindow").window({ // 跳轉到  /page/item-edit
        		onLoad :function(){
        			//獲取選中的記錄 回顯數據
        ...
        handler:function(){
        	...
        	$.messager.confirm('確認','確認上架ID為 '+ids+' 的商品嗎?',function(r){
        	    if (r){
        	    	var params = {"ids":ids};
