...
<div class="w w1 header clearfix">
	...
	<div class="progress clearfix">
		<ul class="progress-1">
			<li class="step-1"><b></b>1.我的購物車</li>
			<li class="step-2"><b></b>2.填寫核對訂單明細</li>
			<li class="step-3">3.成功送出訂單</li>
		</ul>
	</div>
</div>
<div class="w cart">
...
<div class="cart-inner">
    <div class="cart-thead clearfix">
        <div class="column t-checkbox form"><input data-cart="toggle-cb" name="toggle-checkboxes" id="toggle-checkboxes_up" type="checkbox" checked="" value=""><label for="toggle-checkboxes_up">全選</label></div>
        <div class="column t-goods">商品</div>
        <div class="column t-price">價格</div>
        <div class="column t-promotion">優惠價</div>
        <div class="column t-inventory">庫存</div>
        <div class="column t-quantity">數量</div>
        ...
        <c:forEach items="${cartList}" var="cart">
	        ...
	        <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
		        <div class="item_form clearfix">
		            ...
		            <div class="cell p-inventory stock-11345721">有貨</div>
          ...
          <div class="cart-toolbar clearfix">
            <div class="total fr">
                <p><span class="totalSkuPrice">$<fmt:formatNumber value="${totalPrice / 100}" maxFractionDigits="2" minFractionDigits="2" groupingUsed="true"/></span>總金額：</p>
        ...
        <div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;"><div class="cart-dibu ui-ceilinglamp-current" style="width: 988px; height: 49px;">
          <div class="control fdibu fdibucurrent">
              ...
              <span class="shopping">
                  ...
                  <a href="http://www.jt.com/" target="_blank" clstag="clickcart|keycount|xincart|coudanlink" id="continue">繼續購物</a>
              </span>
          </div>
          <div class="cart-total-2014">
              <div class="cart-button">
                  <span class="check-comm-btns" id="checkout-jd">
                      <a class="checkout" href="/order/create.html" clstag="clickcart|keycount|xincart|gotoOrderInfo" id="toSettlement">去結帳<b></b></a>
                  </span>
