...
<form id="formlogin" method="post" onsubmit="return false;">
    ...
    <div class=" w1" id="entry">
        <div class="mc " id="bgDiv">
            ...
            <div class="form ">
                ...
                <div class="item login-btn2013">
                    <input type="button" class="btn-img btn-entry" id="loginsubmit" value="登入" tabindex="8" clstag="passport|keycount|login|06"/>
                </div>
            </div>
        ...
        <div class="free-regist">
            <span><a href="http://www.jt.com/user/register.html" clstag="passport|keycount|login|08">免費註冊&gt;&gt;</a></span>
        </div>
    </div>
</form>
<div class="w1">
