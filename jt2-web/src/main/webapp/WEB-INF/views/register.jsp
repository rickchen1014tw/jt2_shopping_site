...
<div class="w" id="logo">
    <div>
    	<a href="http://www.jt.com/">
    		<img src="/images/jt-logo.png" alt="Demo購物商城" width="170" height="60"/>
    	</a> 
    </div>
</div>
...
<div class="w" id="regist">
    <div class="mt">
        ...
        <div class="extra">
        <span style="text-align: right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> <span>我已經註冊過，馬上&nbsp;<a
                href="http://www.jt.com/user/login.html"
                class="flk13">登入</a></span>
        </div>
    </div>
    <div class="mc">
        <form id="personRegForm" method="POST" onsubmit="return false;">
            ...
            <div class="form" onselectstart="return false;">
                <div class="item" id="select-regName">
                    <span class="label"><b class="ftx04">*</b>用戶名稱：</span>
                ...
                <div id="capslock"><i></i><s></s>鍵盤大寫鎖定已打開，請注意大小寫</div>
                <div id="o-password">
                    <div class="item">
                        <span class="label"><b class="ftx04">*</b>設定密碼：</span>
                    ...
                    <div class="item">
                        <span class="label"><b class="ftx04">*</b>確認密碼：</span>
                        ...
                        <span class="label"><b class="ftx04">*</b>手機號碼：</span>
                    ...
                    <div class="fl item-ifo">
                        ...
                        <label for="protocol">我已閱讀並同意《Demo購物商城用戶註冊協議》</a></label>
                        <span class="clr"></span>
                        <label id="protocol_error" class="error hide">請接受用戶註冊協議</label>
                    </div>
                </div>
                <div class="item">
                    <span class="label">&nbsp;</span>
                    <input type="button" class="btn-img btn-regist" id="registsubmit" value="立即註冊" tabindex="8"
