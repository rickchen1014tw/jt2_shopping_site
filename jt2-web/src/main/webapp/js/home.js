...
BackPanelNew.prototype = {init: function(t) {
        ...
        var e = $.extend({cName: "backtop",text: "<s></s>\u9802\u90e8",href: "#none",target: "_self",newTag: !1,scrollTo: 0,fn: function() {
            }}, t);
...
(function() {
    ...
    new BackPanelNew({id: "backpanel0708",start: 10}).init({text: "\u8fd4\u56de\u9802\u90e8",fn: function() {
