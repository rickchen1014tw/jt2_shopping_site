...
var validatePrompt = {
    regName: {
        onFocus: "6-20個字元，請使用中英文、數字及\"-\"、\"_\"組合",
        succeed: "",
        isNull: "請輸入用戶用稱",
        error: {
            beUsed: "這個用戶名稱已被使用，請重新輸入",
            badLength: "用戶名稱長度只能在6-20個字元之間",
            badFormat: "用戶名稱只能由中文、英文、數字及\"-\"、\"_\"組成",
            fullNumberName: "用戶名稱不能是純數字，請重新輸入"
        },
    ...
    pwd: {
        onFocus: "<span>6-20個字元，可使用英文字母、數字或符號的組合，不建議使用純英文字母、純數字或純符號</span>",
        succeed: "",
        isNull: "請輸入密碼",
        error: {
            badLength: "密碼長度只能在6-20個字元之間",
            badFormat: "密碼只能由英文、數字及標點符號組成",
            simplePwd: "<span>該密碼比較簡單，有被盜風險，建議您更改為複雜密碼，如英文字母+數字的組合</span>",
            weakPwd: "<span>該密碼比較簡單，有被盜風險，建議您更改為複雜密碼</span>"
        },
        onFocusExpand: function() {
            $("#pwdstrength").hide();
        }
    ...
    pwdRepeat: {
        ...
        error: {
            badLength: "密碼長度只能在6-20個字元之間",
            badFormat2: "兩次輸入密碼不一致",
            badFormat1: "密碼只能由英文、數字及標點符號組成"
        }
    },
    phone: {
        onFocus: "請輸入手機號碼",
...
function checkPin(option) {
    ...
    if (!namestate || nameold != pin) {
        if (nameold != pin) {
            nameold = pin;
            option.errorEle.html("<em style='color:#999'>檢查中……</em>");
            $.ajax({
            	...
            	success : function(data) {
                    ...
                    if (!data.data) {
                        ...
                        validateSettings.error.run(option, "這個用戶名稱已被使用！");
                        namestate = false;
                    }
                }
            });
...
function sendMobileCode() {
    ...
    if (validateRules.isNull(mobile)) {
        $("#phone_error").removeClass().addClass("error").html("請輸入手機號碼");
        $("#phone_error").show();
        return;
    }
    if (!validateRules.isMobile(mobile)) {
        $("#phone_error").removeClass().addClass("error").html("手机号码格式有误，请输入正确的手机号1");
        $("#phone_error").show();
        return;
    }
...
function sendMobileCode1() {
    ...
    if (!validateRules.isMobile(mobile)) {
        $("#phone1_error").removeClass().addClass("error").html("手机号码格式有误，请输入正确的手机号2");
        $("#phone1_error").show();
        $("#phone1_succeed").removeClass().addClass("blank error-ico");
        return;
    }
    ...
    if (!validateRules.isMobile(mobile)) {
        $("#phone1_error").html("手机号码格式有误，请输入正确的手机号3");
...
function mobileReg() {
    ...
    if (mobile == "") {
        ...
        $("#phone1_error").html("手机号码格式有误，请输入正确的手机号4");
        $("#phone1_error").removeClass().addClass("error");
        $("#phone1_succeed").removeClass().addClass("blank error-ico");
        $("#phone1_error").show();
        $('#phone1').removeClass().addClass('text highlight2');
...
function phoneFocus() {
    ...
    $("#phone_error").removeClass().addClass("focus").html("請輸入手機號碼");
    $("#phone_error").show();
...
function phone1Focus() {
    ...
    $("#phone1_error").removeClass().addClass("focus").html("請輸入手機號碼");
    $("#phone1_error").show();
    $('#phone1_succeed').removeClass('error-ico');
}
...
function phoneBlur() {
    ...
    if (validateRules.isNull(mobile) || !validateRules.isMobile(mobile)) {
        $('#phone').removeClass().addClass('text highlight2');
        $("#phone_error").html("手機號碼格式有錯誤，請輸入正確的手機號碼");
        $("#phone_error").removeClass().addClass("error");
        $("#phone_error").show();
        $("#phone_succeed").removeClass().addClass("");
        $("#rebind").remove();
...
function phoneKeyup() {
    ...
    if (validateRules.isNull(mobile) || !validateRules.isMobile(mobile)) {
        $('#phone').removeClass().addClass('text highlight2');
        $("#phone_error").html("手机号码格式有误，请输入正确的手机号6");
        $("#phone_error").removeClass().addClass("error");
        $("#phone_error").show();
        $("#phone_succeed").removeClass().addClass("");
        $("#rebind").remove();
...
function phoneOtherBlur() {
    ...
    if (validateRules.isNull(mobile) || !validateRules.isMobile(mobile)) {
        $('#phone').removeClass().addClass('text highlight2');
        $("#phone_error").html("手机号码格式有误，请输入正确的手机号7");
        $("#phone_error").removeClass().addClass("error");
        $("#phone_error").show();
        $("#phone_succeed").removeClass().addClass("");
        mobileFlags = false;
...
function phoneOtherKeyup() {
    ...
    if (validateRules.isNull(mobile) || !validateRules.isMobile(mobile)) {
        $('#phone').removeClass().addClass('text highlight2');
        $("#phone_error").html("手机号码格式有误，请输入正确的手机号8");
        $("#phone_error").removeClass().addClass("error");
        $("#phone_error").show();
        $("#phone_succeed").removeClass().addClass("");
        mobileFlags = false;
...
function phone1Blur() {
    ...
    if (validateRules.isNull(mobile) || !validateRules.isMobile(mobile)) {
        $("#phone1_error").html("手机号码格式有误，请输入正确的手机号9");
        $("#phone1_error").removeClass().addClass("error");
        $("#phone1_succeed").removeClass().addClass("blank error-ico");
        $("#phone1_error").show();
        $('#phone1').removeClass().addClass('text highlight2');
...
function phone1Keyup() {
    ...
    if (validateRules.isNull(mobile) || !validateRules.isMobile(mobile)) {
        $("#phone1_error").html("手机号码格式有误，请输入正确的手机号10");
        $("#phone1_error").removeClass().addClass("error");
        $("#phone1_succeed").removeClass().addClass("blank error-ico");
        $("#phone1_error").show();
        $('#phone1').removeClass().addClass('text highlight2');
